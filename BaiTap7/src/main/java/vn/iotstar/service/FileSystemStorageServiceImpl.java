...
public class FileSystemStorageServiceImpl implements IStorageService { 
    ...
    public void store(MultipartFile file, String storeFilename) { 
        ...
        } catch (Exception e) { throw new StorageException("Failed to store file: ", e); } 
    } 
    ...
    public Resource loadAsResource(String filename) { 
        ...
        } catch (Exception e) { throw new StorageException("Could not read file: " + filename); } 
    } 
    ...
    @Override public void delete(String storeFilename) throws Exception { 
        Files.delete(rootLocation.resolve(Paths.get(storeFilename)).normalize().toAbsolutePath()); 
    } 
    @Override public void init() { 
        try { Files.createDirectories(rootLocation); } catch (Exception e) { throw new StorageException("Could not init storage", e); } 
    } 
} 
