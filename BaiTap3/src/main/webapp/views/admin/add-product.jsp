    ...
    <div class="workspace-wrapper">
        <div class="app-sidebar">
            ...
            <div class="navigation-menu">
                ...
                <div class="sub-menu">
                    <a href="<c:url value='/admin/product/add'/>" class="sub-link active">
                        <i class="fa-solid fa-circle" style="color: #74c0fc;"></i> Thêm sản phẩm mới
                    </a>
        ...
        <div class="content-canvas">
            ...
            <div class="form-card">
                <h3><i class="fas fa-plus-circle" style="margin-right: 8px;"></i>Tạo sản phẩm</h3>
                ...
                <form action="<c:url value='/admin/product/insert'/>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label><i class="fas fa-image" style="margin-right: 6px; color: #495057;"></i>Ảnh sản phẩm:</label>
                    ...
                    <div class="btn-group">
                        <button type="submit" class="btn-submit"><i class="fas fa-save" style="margin-right: 6px;"></i>Thêm sản phẩm</button>
