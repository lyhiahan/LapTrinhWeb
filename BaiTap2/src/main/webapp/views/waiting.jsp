...
<div class="container container-wide">
    ...
    <div style="display: flex; gap: 15px;">
        <a href="${pageContext.request.contextPath}/admin/categories" class="btn" style="text-align: center; display: block; width: 100%;">
            Quản lý danh mục
        </a>
        <a href="${pageContext.request.contextPath}/logout" class="btn btn-secondary" style="text-align: center; display: block; width: 100%;">
            Đăng xuất
        </a>
    </div>
</div>
